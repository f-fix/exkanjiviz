...
Visualization of the contents of CGROM2.0's CGROM60.62, CGROM60m.62, and KANJIROM.62 from https://eighttails.seesaa.net/article/305067428.html (it has some missing kanji, some misplaced kanji, and some wrong semigraphics characters, so please consider using a different solution)
...
## Footnote: full VDG text mode dump
I noticed that one of the SG6 patterns in the PC-6001 mkII CGROM has a glitch (it's confirmed by many dumps made both by me, and by others.) I made a "full" VDG text mode dumper to see whether such a glitch is also present in the video output of the M5C6847P-1. I ran the updated "full" dumper on my PC-6001, using the same capture setup as I previously used for the "orange" dumper. This confirms there's no glitch in the SG6 patterns generated by the PC-6001's Mitsubishi VDG - indeed, that was a unique bug NEC introduced in the mkII CGROM. The VDG SG4 and SG6 patterns appear identical to those generated in the naive way based on the corresponding bits in the VRAM bytes - unsurprisingly, since otherwise this would involve strangely wasteful ROM inside the VDG.

The glitchy area of the PC-6001 mkII CGROM, seen here in an excerpt from an emulator screenshot:
<img width="135" height="98" alt="image" src="https://github.com/user-attachments/assets/96c15c2f-98b5-423f-9c90-b35f310fdfbb" />

The "full" version of the VDG text mode dumper:
```basic
10 CONSOLE,,0
20 CLS
25 FOR K=0 TO 3
...
100 NEXT K
130 FOR I=0 TO 255
140 POKE &HC000+I+I,&H60
150 POKE &HC200+I+I,I
160 POKE &HC000+I+I+1,&H62
170 POKE &HC200+I+I+1,I
180 NEXT
190 IFINKEY$=""THENGOTO190
200 CONSOLE,,1
210 CLS
```

Output:
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/cb5c9612-2036-4ad8-ac40-db6b41413165" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/55aee456-4bd3-460f-821f-17eccdba2942" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/e7bb2892-9832-44dd-b774-e92b4f989cd0" />
<img width="808" height="455" alt="image" src="https://github.com/user-attachments/assets/4191f908-cf4f-4c3f-bbc3-b9a9d8851f56" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/fc02dee1-aaa9-4244-8897-2302aa42971f" />

Again, but treating video signal as Y component:
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/0400834c-1c39-4034-afbd-4a07fa86514c" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/82987cc4-9b85-4a3b-a164-342aa9228b9a" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/cfd5a538-ef8b-46a6-9de2-bdc2c6dc2a4f" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/974d259a-356b-43bf-818c-03d24d492b6a" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/ad492d13-9e92-44b3-aecb-70f5b1068dd3" />

Recaptured from the same source, only using a different and differently-configured RetroTink 5X with more recent firmware and reduced chroma setting specifically for Papicom:
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/7a0b7c71-192d-48d5-83c0-c98fa33198fa" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/b02b12ec-c59f-4725-83df-95587875096d" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/bd50c655-9272-4f19-85ac-75a2006b3fce" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/7c97fe7e-dcf7-4e91-8957-015712556d79" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/ea8b59fc-a85f-4001-bcb4-b93c743e170e" />

Again, but treating video signal as Y component:
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/f3c44a84-7b66-460d-b0ac-f03050b00fe0" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/ce96c0ef-4c0a-4cc1-a697-f10f651ec12a" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/3c9b306e-1729-433c-9ff9-0162f4954ad4" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/a1b5b019-933d-49c6-8633-6abb8e37e99d" />
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/8423d4c2-0f4e-4d1e-a89b-5213e6aa7759" />
